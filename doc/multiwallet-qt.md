...
In order to support loading of multiple wallets in triskelpremium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is triskelpremium.cpp.
...
Changes to triskelpremium.cpp
----------------------
triskelpremium.cpp is the entry point into triskelpremium-qt, and as such, will require some minor modifications to provide hooks for
