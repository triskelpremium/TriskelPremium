...
#   c) node1 mines 32 blocks, so now node 0 has 500000TKP, node 1 has 4250TKP, node2 has none.
#   d) node0 sends 601 TKP to node2, in two transactions (301 TKP, then 300 TKP).
